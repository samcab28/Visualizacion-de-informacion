...
Eje X (Delito): Este eje muestra los diferentes tipos de delitos considerados en el análisis.

Eje Y (Cantidad de víctimas): Representa la cantidad de víctimas asociadas a cada tipo de delito. La altura de las barras indica cuántas víctimas hubo para cada categoría de delito.

Color (Edad): El color de las barras indica la edad de las víctimas. Cada color representa un rango de edad diferente, lo que permite visualizar la distribución de las víctimas por edad dentro de cada tipo de delito.

Facetas (Género y Hora): El gráfico utiliza facetas para desglosar los datos por género y hora. Cada faceta muestra cómo se distribuyen las víctimas por edad y delito para un género específico y en un momento del día determinado. Esto proporciona una visión detallada de cómo varía la distribución de las víctimas según el género y la hora del día en que ocurrieron los delitos.

En resumen, el gráfico de facetas proporciona una visualización detallada de la cantidad de víctimas por tipo de delito, desglosada por edad, género y hora, lo que permite identificar patrones o tendencias en los datos.
...
# Mostrar el gráfico interactivo
grafico_facetas_interactivo_otra
