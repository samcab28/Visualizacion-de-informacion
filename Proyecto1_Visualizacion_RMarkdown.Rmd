...
El código filtra los datos para excluir las filas donde el género es desconocido y luego crea un gráfico de barras con facetas. Este gráfico muestra la cantidad de víctimas por tipo de delito, desglosado por edad y género, y además, facetas por provincia. Cada barra en el gráfico representa la cantidad de víctimas para un tipo de delito específico, con diferentes colores que indican diferentes rangos de edad. Las facetas separan los datos por provincia y género, lo que permite analizar cómo varía la distribución de las víctimas según la provincia, el género y la edad. El resultado es una visualización detallada que ayuda a identificar patrones o tendencias en los datos de víctimas de delitos.

```{r,echo=FALSE}

datos_filtrados_faceta <- datos_filtrados[datos_filtrados$Genero != "DESCONOCIDO",]

# Crear el gráfico de facetas de tres o más variables
grafico_facetas <- ggplot(datos_filtrados_faceta, aes(x = Delito, fill = Edad)) +
  geom_bar(position = "dodge") +
